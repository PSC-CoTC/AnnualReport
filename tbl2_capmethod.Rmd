...
t2_gt_cdn <- t2_cdn %>%
  ...
  tab_footnote(footnote = md("<sup>&dagger;</sup>The base ER cap before the unused portion from the intercepting party is included. See PST chapter 5 paragraphs 8 to 9.")) %>%
