...
big.bar.footnote <- str_glue("Interior Fraser Coho ERs calculated using escapement without an estimated {big.bar.mort.txt} Big Bar mortalities are highlighted in yellow")
